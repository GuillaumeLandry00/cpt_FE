        ...
        <>
            ...
            <div className="flex flex-wrap -mx-3 mt-2">
                <div className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <input type="text" name="courriel" defaultValue={data ? data.courriel : ""} className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" required />
                </div>
                <div className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
