    ...
    const divClient = (id: number,) => {
        return (
            <div key={id} className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                ...
                <Select name={"Cpassager_" + id} options={clients} className="block appearance-none w-full  text-gray-700 py-1 px-1 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" />
            </div>
        );
    }
        ...
        <>
            ...
            <div className="flex flex-wrap -mx-3 mt-2">
                <div className="w-full md:w-1/4 px-3 mb-6 md:mb-0">
                    ...
                    <Select name={"Cpassager_" + 0} options={clients} className="block appearance-none w-full  text-gray-700 py-1 px-1 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" />
                </div>
