...
const Terms = ({ data }: ISingleProps) => {
    ...
    useEffect(() => {
        if (data.assurance) {
            (document.getElementById("assurance") as HTMLFormElement).checked = data.assurance == "OUI"
        }
    }, [data])
            ...
            <div className="flex flex-wrap -mx-3 mt-2">
                <div className="w-full md:w-1/4  row flex items-center">
                    ...
                    <input
                        ...
                        name="assurance"
                    />
                    {/* <Select options={CHOICES} id="assurance" value={assurance} onChange={(e) => setAssurance({ label: e?.label as string, value: e?.value as string })} /> */}
                </div>
                ...
                <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label htmlFor="" className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2">Notes personnelles <span className="underline">(Non visible par le client)</span></label>
