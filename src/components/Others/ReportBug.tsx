        ...
        <>
            <div className="w-4/5 ml-auto mr-auto">
                ...
                <div className="w-full min-h-55">
                    <ReactQuill theme="snow" value={(value)} onChange={setValue} placeholder="Veuillez écrire les détails du bug ici. (Comment il est arrivé ?, À quel endroit exactement ?, Après quelle manipulation ?) Veuillez fournir le plus de détails possibles. IMPORTANT: SI VOUS AVEZ UN PROBLÈME AVEC UNE FACTURE, VEUILLEZ FOURNIR SON NUMÉRO" />
                </div>
