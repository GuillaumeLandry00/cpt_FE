...
import { addPurchases, deletePurchase, getPurchase } from "../../../functions/accounting/purchase";
...
const DeletingPurchases = ({ fetchPurchases, id, setShowModal, setResponse }: Props) => {


    const deletePurchases = async () => {
        if ((await deletePurchase(id)).affectedRows > 0) {
