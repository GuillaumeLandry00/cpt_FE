...
import { addTaxes, validateTaxes } from "../../../functions/accounting/taxes";
...
const AddCompensationFunds = ({ fetchPurchases, setResponse }: Props) => {
    ...
    const handleBtn = async () => {
        ...
        if (myForm != null) {
            ...
            if (validateTaxes(values as ITaxes)) {
                if ((await addTaxes(values as ITaxes)).affectedRows > 0) {
                    setResponse("Taxe ajoutée !");
                    fetchPurchases();
                    myForm.reset();
                } else {
                    alert("Erreur");
    ...
    return (
        <div className="">
            <h1 className="text-xl"> - Ajouter une taxe</h1>
                ...
                <div className="flex flex-wrap -mx-3 mb-2">
                    ...
                    <div className="w-1/6 md:w-1/4 px-3 mb-6 md:mb-0">
                        ...
                        <div className="relative">
                            <select required name="type" className="block appearance-none w-full bg-gray-200 border border-gray-200 text-gray-700 py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-gray-500" >
