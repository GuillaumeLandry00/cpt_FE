...
export const PRODUCT_TYPE = [
    { label: `Air Canada /Vol`, value: `Air Canada /Vol` },
    { label: `Alio`, value: `Alio` },
    { label: `Amerik Aventure `, value: `Amerik Aventure ` },
    { label: `Amtrak`, value: `Amtrak` },
    { label: `Archaeological Paths`, value: `Archaeological Paths` },
    { label: `Atlantis Events`, value: `Atlantis Events` },
    { label: `Auto Europe`, value: `Auto Europe` },
    { label: `Autre`, value: `Autre` },
    { label: `Autre Assurance`, value: `Autre Assurance` },
    { label: `Autres`, value: `Autres` },
    { label: `Avalon Waterways`, value: `Avalon Waterways` },
    { label: `Avianet`, value: `Avianet` },
    { label: `Avis`, value: `Avis` },
    { label: `Beltour`, value: `Beltour` },
    { label: `Boomerang Tours`, value: `Boomerang Tours` },
    { label: `Canandes Forfait`, value: `Canandes Forfait` },
    { label: `Canandes Vol`, value: `Canandes Vol` },
    { label: `CaribeSol Forfait`, value: `CaribeSol Forfait` },
    { label: `CaribeSol Vol`, value: `CaribeSol Vol` },
    { label: `Carte Postale`, value: `Carte Postale` },
    { label: `Cartes d'affaires`, value: `Cartes d'affaires` },
    { label: `Cassis`, value: `Cassis` },
    { label: `Celebritours`, value: `Celebritours` },
    { label: `Central Mountain Air`, value: `Central Mountain Air` },
    { label: `Certificat`, value: `Certificat` },
    { label: `CIT Canada`, value: `CIT Canada` },
    { label: `Club Med`, value: `Club Med` },
    { label: `Contiki`, value: `Contiki` },
    { label: `Cotisation AFL`, value: `Cotisation AFL` },
    { label: `Croisière Russie`, value: `Croisière Russie` },
    { label: `Croisières Divers`, value: `Croisières Divers` },
    { label: `Croix Bleue`, value: `Croix Bleue` },
    { label: `Cubana`, value: `Cubana` },
    { label: `Days Inn Opc`, value: `Days Inn Opc` },
    { label: `Disney`, value: `Disney` },
    { label: `Divers`, value: `Divers` },
    { label: `Divers`, value: `Divers` },
    { label: `Don à la fondation pour l'enfance`, value: `Don à la fondation pour l'enfance` },
    { label: `Dubai`, value: `Dubai` },
    { label: `Dubai À La Carte`, value: `Dubai À La Carte` },
    { label: `Dubai Croisière`, value: `Dubai Croisière` },
    { label: `Encore Cruises`, value: `Encore Cruises` },
    { label: `Esprit`, value: `Esprit` },
    { label: `Eurocar Vacances`, value: `Eurocar Vacances` },
    { label: `Europcar`, value: `Europcar` },
    { label: `Europe Auto`, value: `Europe Auto` },
    { label: `EvaCroisiere`, value: `EvaCroisiere` },
    { label: `Exotik Tours`, value: `Exotik Tours` },
    { label: `Expedia Vol`, value: `Expedia Vol` },
    { label: `Expertours`, value: `Expertours` },
    { label: `Flextour`, value: `Flextour` },
    { label: `Formations Agts Externes`, value: `Formations Agts Externes` },
    { label: `Frais d'émission de billet(s)`, value: `Frais d'émission de billet(s)` },
    { label: `Frais de dossier`, value: `Frais de dossier` },
    { label: `FTO - Traitement de dossier`, value: `FTO - Traitement de dossier` },
    { label: `Fun Sun`, value: `Fun Sun` },
    { label: `Fun Sun Vacations`, value: `Fun Sun Vacations` },
    { label: `Gapventures`, value: `Gapventures` },
    { label: `Globus`, value: `Globus` },
    { label: `Gogo Woldwide Vacations`, value: `Gogo Woldwide Vacations` },
    { label: `Gr Voyages Quebec`, value: `Gr Voyages Quebec` },
    { label: `Grands Espaces Sarl`, value: `Grands Espaces Sarl` },
    { label: `Groupe Vacances`, value: `Groupe Vacances` },
    { label: `Groupe VIP`, value: `Groupe VIP` },
    { label: `Gtahotels.com`, value: `Gtahotels.com` },
    { label: `Hertz `, value: `Hertz ` },
    { label: `Hi Tours`, value: `Hi Tours` },
    { label: `Holasun`, value: `Holasun` },
    { label: `Hôtel Divers`, value: `Hôtel Divers` },
    { label: `hotel.com`, value: `hotel.com` },
    { label: `Huntington`, value: `Huntington` },
    { label: `Incursion Voyages`, value: `Incursion Voyages` },
    { label: `Int Divers`, value: `Int Divers` },
    { label: `IntairAuto`, value: `IntairAuto` },
    { label: `Intersky`, value: `Intersky` },
    { label: `IntHôtel`, value: `IntHôtel` },
    { label: `IntVol`, value: `IntVol` },
    { label: `Jade Tours`, value: `Jade Tours` },
    { label: `Jevisite.ca`, value: `Jevisite.ca` },
    { label: `Le Groupe VIP`, value: `Le Groupe VIP` },
    { label: `Loc Appart`, value: `Loc Appart` },
    { label: `Lunettes`, value: `Lunettes` },
    { label: `Manuvie Ass Ann/Interruption`, value: `Manuvie Ass Ann/Interruption` },
    { label: `Manuvie Ass Covid`, value: `Manuvie Ass Covid` },
    { label: `Manuvie Ass For Médical`, value: `Manuvie Ass For Médical` },
    { label: `Manuvie Ass For Supérieur`, value: `Manuvie Ass For Supérieur` },
    { label: `Manuvie Ass Méd Classiques`, value: `Manuvie Ass Méd Classiques` },
    { label: `Martour`, value: `Martour` },
    { label: `Merika Tours`, value: `Merika Tours` },
    { label: `Merit Express`, value: `Merit Express` },
    { label: `National Car`, value: `National Car` },
    { label: `Netair`, value: `Netair` },
    { label: `New York en Autocar`, value: `New York en Autocar` },
    { label: `Objectif Monde`, value: `Objectif Monde` },
    { label: `Océania Cruises`, value: `Océania Cruises` },
    { label: `Pascan Aviation`, value: `Pascan Aviation` },
    { label: `Porter`, value: `Porter` },
    { label: `Pourboire Prépayé`, value: `Pourboire Prépayé` },
    { label: `Premium Tours`, value: `Premium Tours` },
    { label: `Princess`, value: `Princess` },
    { label: `Princess `, value: `Princess ` },
    { label: `Provincial Airlines `, value: `Provincial Airlines ` },
    { label: `Pullmantur`, value: `Pullmantur` },
    { label: `Quel Beau  Voyage`, value: `Quel Beau  Voyage` },
    { label: `Quimbaya International`, value: `Quimbaya International` },
    { label: `Rail Europe`, value: `Rail Europe` },
    { label: `Remboursement`, value: `Remboursement` },
    { label: `Royal Scenic`, value: `Royal Scenic` },
    { label: `Sandals Forfait`, value: `Sandals Forfait` },
    { label: `Sél de Sièges`, value: `Sél de Sièges` },
    { label: `Sign Forfait`, value: `Sign Forfait` },
    { label: `Simp Tours`, value: `Simp Tours` },
    { label: `Skylink`, value: `Skylink` },
    { label: `Skyroute`, value: `Skyroute` },
    { label: `Solazur`, value: `Solazur` },
    { label: `Spartan Tours`, value: `Spartan Tours` },
    { label: `Sport Vac`, value: `Sport Vac` },
    { label: `Sultana Tours`, value: `Sultana Tours` },
    { label: `Sunquest`, value: `Sunquest` },
    { label: `Sunwing  Ass`, value: `Sunwing  Ass` },
    { label: `Sunwing Forfait`, value: `Sunwing Forfait` },
    { label: `Sunwing Vol`, value: `Sunwing Vol` },
    { label: `TMA`, value: `TMA` },
    { label: `Tour Hai`, value: `Tour Hai` },
    { label: `Tour Solazur`, value: `Tour Solazur` },
    { label: `Tourclub`, value: `Tourclub` },
    { label: `Tourico`, value: `Tourico` },
    { label: `Tours Amerique`, value: `Tours Amerique` },
    { label: `Tours Chanteclerc`, value: `Tours Chanteclerc` },
    { label: `Tours East`, value: `Tours East` },
    { label: `Trafalgar Tours`, value: `Trafalgar Tours` },
    { label: `Transat Forfait`, value: `Transat Forfait` },
    { label: `Transfert`, value: `Transfert` },
    { label: `Travelport`, value: `Travelport` },
    { label: `Unikatours/Tours Jules Verne`, value: `Unikatours/Tours Jules Verne` },
    { label: `Unique Vacations`, value: `Unique Vacations` },
    { label: `Vac Air Canada`, value: `Vac Air Canada` },
    { label: `Vac Croisière`, value: `Vac Croisière` },
    { label: `Vac Préférence`, value: `Vac Préférence` },
    { label: `Vac Signature Vol`, value: `Vac Signature Vol` },
    { label: `Vac Summa`, value: `Vac Summa` },
    { label: `Vac WestJet`, value: `Vac WestJet` },
    { label: `Vacation Central`, value: `Vacation Central` },
    { label: `Valises et Accessoires`, value: `Valises et Accessoires` },
    { label: `Vat Auto`, value: `Vat Auto` },
    { label: `Vat Circuit`, value: `Vat Circuit` },
    { label: `Vat Croisière`, value: `Vat Croisière` },
    { label: `Vat Divers`, value: `Vat Divers` },
    { label: `Vat For`, value: `Vat For` },
    { label: `Vat Hôtel`, value: `Vat Hôtel` },
    { label: `Vat Vol`, value: `Vat Vol` },
    { label: `Via Rail`, value: `Via Rail` },
    { label: `Viator`, value: `Viator` },
    { label: `Viking Cruises`, value: `Viking Cruises` },
    { label: `Vol Divers`, value: `Vol Divers` },
    { label: `VToursEtudiant`, value: `VToursEtudiant` },
    { label: `West Jet Forfait`, value: `West Jet Forfait` },
    { label: `WestJet Vol`, value: `WestJet Vol` },
    { label: `Avianet/ Terratours`, value: `Avianet/ Terratours` },
    { label: `Contrat Echange`, value: `Contrat Echange` },
    { label: `DaysInn`, value: `DaysInn` },
    { label: `Delta  Airlines`, value: `Delta  Airlines` },
    { label: `Ex-Produit 1`, value: `Ex-Produit 1` },
    { label: `Ex-Produit 2`, value: `Ex-Produit 2` },
    { label: `Expedia Hôtel`, value: `Expedia Hôtel` },
    { label: `Forfait Divers`, value: `Forfait Divers` },
    { label: `Forfaits Las Vegas`, value: `Forfaits Las Vegas` },
    { label: `Frais de dossier`, value: `Frais de dossier` },
    { label: `Frais Dossier`, value: `Frais Dossier` },
    { label: `Selection Siege OPC`, value: `Selection Siege OPC` },
    { label: `Transfert`, value: `Transfert` },
    { label: `Unikatours`, value: `Unikatours` },
